...
/* -------------------------------------------------------------------------- */
exports.validateLogin = function (_a) {
    var usernameOrEmail = _a.usernameOrEmail, password = _a.password;
    return __awaiter(void 0, void 0, void 0, function () {
        var errors, user, isMatch, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    user = null;
                    isMatch = false;
                    if (!!validator_1.default.isEmpty(usernameOrEmail)) return [3 /*break*/, 6];
                    _c.label = 1;
                case 1:
                    _c.trys.push([1, 5, , 6]);
                ...
                case 6:
                     ...
                     * Email validation
                     */
                    validator_1.default.isEmpty(usernameOrEmail)
